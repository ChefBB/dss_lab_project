...
with open(os.path.join(OUT_DIR, "DimArtistGeography.csv"), "w", newline="", encoding="utf-8") as f:
    ...
    w.writerow(["GeoKey", "BirthPlace", "Province", "Region", "Country", "Latitude", "Longitude"])
...
for t in tracks:
    alb_key = t["new_id_album"]
    if alb_key not in album_seen:
        album_seen[alb_key] = [
            t["album_name"],
