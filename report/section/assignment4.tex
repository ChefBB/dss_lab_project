...
La figura~\ref{fig:conc} riporta lo schema concettuale definitivo.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/Screenshot 2025-12-30 at 10.42.49.png}
    \caption{Schema concettuale}
    \label{fig:conc}
\end{figure}

Dallo schema emerge che la fact table (denominata
\textit{FactParticipation}) modella esplicitamente la partecipazione di
un artista a una canzone.
